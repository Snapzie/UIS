...
\begin{itemize}
  ...
  \item Receptfornyelse på Min Sundhedsplatform \todo{Sarah: Men dette er desværre ikke rigtig, fordi vi har slet ikke spurgt ind til receptfornyelse i nogen vores interview i dybdeanalysen, og derfor skrevet i dybdeanalysen at receptfornyelse har lavt prioritet. Nr. 3 i dybdeanalyse prioritetens liste var: Uniforme prøvesvar}
\end{itemize}
Af ovenstående fokuspunkter er særligt det om samling af information og receptfornyelse på Min Sundhedsplatform blevet arbejdet med yderligere i denne fase og udgør fundament for vores prototype.\todo{Sarah: Men nej, det har det præcis ikke været. Vi kan ikke bruge noget af det vi skrevet i dybdeanalysen som fundament for vores prototype} 
