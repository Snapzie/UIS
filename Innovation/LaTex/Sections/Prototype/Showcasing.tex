...
Vores prototype forudsætter at der er lavet en database op ved navn 'prototype'. Databasen kan opsættes ved at køre scriptsne \textit{'schema.sql'} og \textit{'schema\_ins.sql'}. Hvis disse scripts bliver benyttet kan prototypen logges på med tre brugere, CPR nummer 5000, 2000 og 1000, som alle har kodeordet 'Hej'.\todo{Remove personal path from 'schema.sql'}
