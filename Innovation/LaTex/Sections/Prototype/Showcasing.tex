...
Vores prototype forudsætter at der er lavet en database op ved navn 'prototype'. Databasen kan opsættes ved at køre scriptsne \textit{'schema.sql'} og \textit{'schema\_ins.sql'}.\todo{Remove personal path from 'schema.sql'}
