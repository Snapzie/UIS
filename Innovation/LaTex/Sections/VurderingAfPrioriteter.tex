...
\todo{Sarah: Spørg Finn - er det brugbar argumentation: der står i vores pensum krav at vi skal kunne lave database (Casper), det kan vi ikke i 'Samling af al information'. Er det et brugbar argument for at nedprioritere, når forundersøgelses-rapportens formål er at firmaets ledelse ud fra rapporten skal kunne beslutte om visionerne skal implementeres. Vil ledeles være ligeglad med denne argumentation, eller er det et gyldigt argument (Sarah)? Skal vi forstille os virkelighedens verden?
}
