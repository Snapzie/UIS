...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    \rhead{Axel og Casper}                             % Højre sidehoved      %
...
\textsc{\large Udvikling af informationssystemer}\\[0.5cm] % Minor heading such as course title
...
\HRule \\[0.4cm]
{ \huge \bfseries Forundersøgelsesrapport\\Diabetes og Min Sundhedsplatform}\\[0.4cm] % Title of your document
\HRule \\[1.5cm]
